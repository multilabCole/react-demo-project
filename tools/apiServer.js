...
server.post("/products/", function(req, res, next) {
  ...
  //   } else {
  req.body.slug = createSlug(req.body.productName); // Generate a slug for new courses.
  next();
  //   }
});

server.post("/users", function(req, res, next) {
  console.log("inside apiServer.js checking payload", req.body)
  req.body.slug = createSlug(req.body.firstName + " " + req.body.lastName); // Generate a slug for new authors.
  next();
});
